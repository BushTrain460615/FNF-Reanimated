CoderA = 'Bushtrain & Eassah' -- PUT CODER'S USER HERE
ComposerB = 'M O N T Y & Laleritose' -- PUT COMPOSER'S USER HERE
ArtistC = 'LionKrono' -- PUT ARTIST'S USER HERE
CharterD = 'Pyrakid Wolfo & Edited by Lion Krono' -- PUT CHARTER'S USER HERE

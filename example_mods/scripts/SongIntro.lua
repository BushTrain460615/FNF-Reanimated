...
IntroTagColor = 'FC0303'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	setTextSize('JukeBoxText', IntroTextSize)
        setTextColor('JukeBoxText', 'FC0303')
	addLuaText('JukeBoxText')
	
	--text for the song name
	makeLuaText('JukeBoxSubText', 'KawaiSprite', 300, -305-IntroTagWidth, 60)
